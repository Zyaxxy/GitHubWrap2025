    ...
    <div className="relative w-full h-screen overflow-hidden bg-mixtape-black text-white font-sans selection:bg-accent-green selection:text-black">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          initial={{ opacity: 0, scale: 1.05, filter: 'blur(10px)', rotate: 1 }}
          animate={{ opacity: 1, scale: 1, filter: 'blur(0px)', rotate: 0 }}
          exit={{ opacity: 0, scale: 0.95, filter: 'blur(10px)', rotate: -1 }}
          transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }} // Custom ease for "pop"
          onClick={handleNext}
        >
